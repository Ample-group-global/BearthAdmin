  ...
  return (
    <div className="flex h-screen" style={{ background: "#f0f2f7", fontFamily: "'hoss-round', 'Figtree', system-ui, sans-serif" }}>
      ...
      <aside
        ...
        style={{ background: "#182035", width: collapsed ? "48px" : "210px", boxShadow: "2px 0 8px rgba(0,0,0,0.18)" }}
      >
        {/* Brand header */}
        {collapsed ? (
        ...
        <nav className="flex-1 py-2 overflow-y-auto overflow-x-hidden" style={{ scrollbarWidth: "none" }}>
          {!collapsed && (
            <p className="px-3 pt-1 pb-1.5 text-[9px] font-bold uppercase tracking-widest" style={{ color: "rgba(255,255,255,0.25)" }}>
              Navigation
            </p>
          )}
